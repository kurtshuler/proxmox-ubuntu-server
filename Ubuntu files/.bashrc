...
# Uncomment the following line to change how often to auto-update (in day>
...
# Uncomment the following line if you want to disable marking untracked f>
# under VCS as dirty. This makes repository status check for large reposi>
# much, much faster.
# DISABLE_UNTRACKED_FILES_DIRTY="true"

# Uncomment the following line if you don't want the repository to be con>
# if there are untracked files.
# SCM_GIT_DISABLE_UNTRACKED_DIRTY="true"

# Uncomment the following line if you want to completely ignore the prese>
# of untracked files in the repository.
# SCM_GIT_IGNORE_UNTRACKED="true"

# Uncomment the following line if you want to change the command executio>
# stamp shown in the history command output.  One of the following values>
...
# Uncomment the following line if you do not want OMB to overwrite the ex>
...
# Which aliases would you like to load? (aliases can be found in ~/.oh-my>
...
# Which plugins would you like to conditionally load? (plugins can be fou>
# Custom plugins may be added to ~/.oh-my-bash/custom/plugins/
# Example format:
#  if [ "$DISPLAY" ] || [ "$SSH" ]; then
...
# ANAND's bash aliases
# https://github.com/htpcBeginner/docker-traefik/blob/master/shared/confi>
# This is my current / up-to-date list of bash aliases.
# This is the exact same file that is on all of my hosts - synced using S>
